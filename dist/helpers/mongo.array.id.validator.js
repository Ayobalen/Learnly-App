...
exports.MongoIDArrayPipe = void 0;
const common_1 = require("@nestjs/common");
const Joi = __importStar(require("joi"));
const mongoIDArray = Joi.alternatives().try(Joi.array()
    .items(Joi.string().regex(/^[a-fA-F0-9]{24}$/))
    .min(1), Joi.string().regex(/^[a-fA-F0-9]{24}$/));
let MongoIDArrayPipe = class MongoIDArrayPipe {
    transform(value) {
